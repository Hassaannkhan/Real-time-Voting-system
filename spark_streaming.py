...
#     spark = SparkSession.builder.appName('voting_sys') \
#         .getOrCreate()
...
#     print('votes df pro 1')
#     # enriched_vote_df = votes_df.withWatermark('voting_time', '15 minute')
#     print('votes df pro 2')
#     # Aggregations
...
#     turnout_by_location = votes_df.groupBy('address_state').count()
#     print('agg')
#     # Write Aggregations Back to Kafka
#     votes_per_candidate_kafka = votes_per_candidate.selectExpr('to_json(struct(*)) AS value') \
#         .writeStream \
#         .format('kafka') \
#         .option('kafka.bootstrap.servers', 'localhost:9092') \
#         .option('topic', 'aggregated_votes_per_candidate') \
#         .option("checkpointLocation", "E:\Real-time Voting SYS\checkpointLocation\checkpointLocation1") \
#         .outputMode('update') \
#         .start()
#     print('per cand')

#     turnout_by_location_kafka = turnout_by_location.selectExpr('to_json(struct(*)) AS value') \
#         .writeStream \
#         .format('kafka') \
#         .option('kafka.bootstrap.servers', 'localhost:9092') \
#         .option('topic', 'aggregated_turnout_by_location') \
#         .option("checkpointLocation", "E:\Real-time Voting SYS\checkpointLocation\checkpointLocation2") \
#         .outputMode('update') \
#         .start()
#     print('turnout')

#     # Wait for Termination
#     turnout_by_location_kafka.awaitTermination()
#     votes_per_candidate_kafka.awaitTermination()
...
if __name__ == "__main__":
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("kafka.bootstrap.servers", "localhost:9092") \
        .option("topic", "aggregated_votes_per_candidate") \
        .option("checkpointLocation", "E:\Real-time Voting SYS\checkpointLocation\checkpoint") \
        .outputMode("update") \
        .start()
